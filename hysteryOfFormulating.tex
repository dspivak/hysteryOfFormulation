...
\newcommand{\snote}[1]{{\color{green!50!black}Sophie says:}~#1\;{\color{green!50!black}$\lozenge$}}
...
\title{The hystery of formulating:\\A mathematical marriage of matter and pattern}
...
\parbox{3in}{\color{gray}{Sophie suggests image here}
}
\parbox{3in}{
...
\hfill ---Beyonc\'e, \emph{Formation}

\vspace{1in}

What is life affirming? What makes living experience meaningful? And what's math got to do with it?
